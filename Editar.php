...
*/
    ...
    if (
        ...
        $produtoVal === ''
        ||
        !is_numeric($produtoVal)
    ) {


        $mensagem =
            '⚠️ Preencha nome e preço corretamente!';
...
<aside class="sidebar">
    ...
    <nav>
        ...
        <div class="nav-item">
            ...
            <!--
                MESMO DESTINO DE LOGIN
                USADO NAS OUTRAS PÁGINAS
            -->

            <a href="Login vs1.0.php">
...
<?php else: ?>
    ...
    <?php if (!empty($mensagem)): ?>
        ...
        <div
            class="mensagem
            <?= htmlspecialchars($mensagem_tipo) ?>"
        >
    ...
    <?php else: ?>
        ...
        <div class="card-form">
            ...
            <form
                ...
                onsubmit="
                    return confirm(
                        '⚠️ Tem certeza que deseja deletar este produto? Essa ação não pode ser desfeita.'
                    );
                "
            >
